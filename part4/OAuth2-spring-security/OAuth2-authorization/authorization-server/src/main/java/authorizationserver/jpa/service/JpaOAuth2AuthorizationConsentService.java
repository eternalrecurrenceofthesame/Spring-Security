package authorizationserver.jpa.service;

import authorizationserver.jpa.entity.AuthorizationConsent;
import authorizationserver.jpa.repository.AuthorizationConsentRepository;
...
/**
 * AuthorizationConsent 를 관리하는 기능을 제공하는 서비스
 *
 * 이 서비스는 사용자의 principal 과 사용자의 클라이언트 유형, authorities 를 저장하는 authorization_consent 테이블을 관리하는 기능을 제공한다.
 */
//@Component
