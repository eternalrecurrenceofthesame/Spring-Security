...
import authorizationserver.jpa.entity.Authorization;
import authorizationserver.jpa.repository.AuthorizationRepository;
...
/**
 * 데이터베이스에 저장되는 Authorization 엔티티 정보의 전반을 관리하는 서비스를 제공한다. 토큰 정보, 사용자 정보 등등 사용자 인가 정보를 관리한다.
 */
